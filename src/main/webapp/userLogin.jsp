                    ...
                    <form id="login_form" action="${prc }/user.do?login" method="post">
                        <div class="panel panel-body login-form">
                            <div class="text-center">
                                ...
                                <h5 class="content-group">用户登录 <small class="display-block">Your credentials</small></h5>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" class="styled" checked="checked">记住密码
                                        </label>
                                    </div>
                            ...
                            <a href="${prc }/userRegist.jsp" class="btn btn-default btn-block content-group">注册</a>
                            <span class="help-block text-center no-margin">您确认您已经阅读了我们的<a href="#">条款</a></span>
                        </div>
                    </form>
                    <!-- /advanced login -->
